...
function Github() {
    const data = useLoaderData()
        ...
        // }, [])
    return(
        <div className="text-center m-4 bg-gray-300 text-black
        p-4 text-5xl  ">Github followers: {data.followers}
...
export const githubInfoLoader = async () => {
    const response = await fetch('https://api.github.com/users/AlokYadavIIIT')
